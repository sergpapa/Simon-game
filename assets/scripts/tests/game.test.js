...
describe("newGame works correctly", () => {
    ...
    test("newGame resets playerMoves array", () => {
        expect(game.playerMoves.length).toBe(0);
    });
    test("should be 1 move in the computer's array", () => {
...
describe("gameplay works correctly", () => {
    ...
    test("should call an alert if player makes wrong move", () => {
    ...
    test("clicking during computer sequesnce should fail", () => {
        showTurns();
        game.lastButton = "";
